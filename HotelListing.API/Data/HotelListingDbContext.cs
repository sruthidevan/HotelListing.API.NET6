    ...
    public class HotelListingDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hotel>().HasData(
                new Hotel { Id = 1, Name = "Sandals Resort and Spa", Address = "Negril", CountryId = 1, Rating = 5 },
                new Hotel { Id = 2, Name = "Comfort Suites", Address = "George Town", CountryId = 3, Rating = 3 },
