...
namespace HotelListing.API.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        public async Task<AuthResponseDto> Login(LoginDto loginDto)
        {
            ...
            _logger.LogInformation($"Token generated successfully for user with email {loginDto.Email}");
        ...
        public async Task<string> CreateRefreshToken()
        {
            ...
            var result =
                await _userManager.SetAuthenticationTokenAsync(_user, LoginProvider, RefreshToken,
                    newRefreshToken);
            return newRefreshToken;
        }

        public async Task<AuthResponseDto> VerifyRefreshTokens(AuthResponseDto request)
        {
